...
public class SwipeDismissListViewTouchListener implements  RecyclerView.OnItemTouchListener {
     ...
     */
    public SwipeDismissListViewTouchListener(RecyclerView recyclerView, SwipeListener listener) {
