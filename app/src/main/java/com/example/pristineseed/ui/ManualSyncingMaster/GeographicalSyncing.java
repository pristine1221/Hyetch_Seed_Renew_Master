...
public class GeographicalSyncing  extends Fragment {
    ...
    private ProgressBar geo_graphic_loading, zone_master_loading, state_master_loading, region_master_loading, distric_master_loading,
            ...
            hytech_role_master_loading,bank_master_loading,uom_master_loading,unit_price_master_loading,ship_to_master_loading
            ,planting_line_lot_list_master_loading,sale_order_no_loading;
    ...
    private TextView geo_count, zonecount, state_count, region_count, distric_count_text, taluka_count, display_area_count, display_count_user_location
            ,display_planting_count_fsio_bsio,display_count_seson_master,display_count_organizer,display_count_farmer,display_count_planting_lot,display_count_city_master
            ,display_count_hybrid,display_count_crop_hytech,
                        ...
                        try {
                            ...
                            try {
                                if (geoGraphicData != null) {
                                   ...
                                   // countmodel.geocount = insertGeographicalSetUp(geoGraphicData.geographical_Setup, db);
