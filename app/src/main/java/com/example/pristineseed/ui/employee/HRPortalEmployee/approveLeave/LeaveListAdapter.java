...
public class LeaveListAdapter extends BaseAdapter {
    ...
    public LeaveListAdapter(Activity activity, List<TravelHeaderModel> listdata, OnItemClickListener listener) {
        super();
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        convertView = inflater.inflate(R.layout.view_leave_listview, null);
        ...
        tv_travel_status.setText(listdata.get(position).created_on  + " " + listdata.get(position).status);
        tv_travel_status.setVisibility(View.GONE);
