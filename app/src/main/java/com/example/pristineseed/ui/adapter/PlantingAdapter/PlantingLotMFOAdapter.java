...
public class PlantingLotMFOAdapter extends ArrayAdapter {
    private Context context;
    private int resourceId;
    private List<PlantingLotModel.Data> items, tempItems, suggestions;


    public PlantingLotMFOAdapter(Context context, int resourceId, List<PlantingLotModel.Data> items) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        try {
            ...
            String doc_no = getItem(position).Lot_No;
            name.setText(doc_no);
    ...
    @Nullable
    @Override
    public PlantingLotModel.Data getItem(int position) {
    ...
    private Filter districtFilter = new Filter() {
        ...
        public CharSequence convertResultToString(Object resultValue) {
            PlantingLotModel.Data planting_lot_master_table = (PlantingLotModel.Data) resultValue;
            return planting_lot_master_table.Lot_No;
        }
...
//                    filterResults.count = suggestions.size();
        ...
        protected void publishResults(CharSequence charSequence, FilterResults filterResults) {
            ArrayList<PlantingLotModel.Data> tempValues = (ArrayList<PlantingLotModel.Data>) filterResults.values;
