...
public class HeaderLineFragment extends Fragment {
    ...
    private HeaderLineViewModel headerLineViewModel;
    SwipeRefreshLayout swipe_refresh_layout;
    Chip complete_header,chip_add_line;
    public View onCreateView(@NonNull LayoutInflater inflater,
                             ViewGroup container, Bundle savedInstanceState) {
        headerLineViewModel =
                ViewModelProviders.of(this).get(HeaderLineViewModel.class);
        View root = inflater.inflate(R.layout.fragment_header_line, container, false);
        return root;
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        listview.setOnItemClickListener((adapterView, view1, i, l) -> {
            PopupMenu popup = new PopupMenu(getActivity(), view1, Gravity.END);
            try {
...
//                Toast.makeText(getActivity(),"s",Toast.LENGTH_LONG).show();
        ...
        complete_header.setOnClickListener(view1 -> {
            Intent mainIntent = new Intent(getActivity(), BottomMainActivity.class);
            mainIntent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK | Intent.FLAG_ACTIVITY_NEW_TASK);
            startActivity(mainIntent);
            getActivity().finish();
        });
        chip_add_line=view.findViewById(R.id.chip_add_line);
        chip_add_line.setOnClickListener(view1 -> {
            AddNewItemPopup();
        });
    }
