...
public class EventTypeAdapter extends ArrayAdapter<EventTypeMasterTable> {
        Context context;
        int resourceId;
        List<EventTypeMasterTable> items;

        public EventTypeAdapter(@NonNull Context context, int resourceId, List<EventTypeMasterTable> items) {
        ...
        public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
                ...
                name.setText(event_type.getEvent_type() + " (" + event_type.getRate() + ")");
                return view;
        }
