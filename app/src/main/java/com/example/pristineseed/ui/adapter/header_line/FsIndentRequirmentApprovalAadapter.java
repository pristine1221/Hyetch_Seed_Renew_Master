...
public class FsIndentRequirmentApprovalAadapter extends BaseAdapter {
    ...
    public FsIndentRequirmentApprovalAadapter(Activity activity, List<FsIndentRequirementsModel> listdata) {
        super();
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        loc_name.setText(listdata.get(position).location + "(" + listdata.get(position).fs_req_code + ")");
