...
public class Germination_InspectionLineModel {
         ...
         public String recommended_dose_of_fertilizer;
         public String recommended_dose_of_fertilizer_in_bags;
         public String basal_dose;
         public String basal_dose_bags;
         public String remark_for_fertilizer;
         public String created_by;
         public String created_on;
         public String date_of_inspection;
         public int sync_with_api;
